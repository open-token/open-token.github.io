...
const useCases = [
  { title: '开源研究', description: '支持学术实验室和开源基金会的突破性 AI 研究，无需预算限制。', icon: FaFlask, items: ['训练新模型', '微调实验', '学术出版'], color: 'from-blue-500 to-cyan-500' },
  { title: 'AI 安全与标准', description: '支持关键的 AI 安全、伦理和标准开发工作，构建负责任的 AI 未来。', icon: FaShieldAlt, items: ['安全基准测试', '伦理研究', '政策制定'], color: 'from-green-500 to-emerald-500' },
  { title: '数据集创建', description: '构建高质量数据集和基准，推动整个 AI 生态系统发展。', icon: FaDatabase, items: ['数据标注', '基准创建', '质量验证'], color: 'from-purple-500 to-pink-500' },
  { title: '黑客松与活动', description: '为 Google Summer of Code 等公益倡议提供免费 AI 访问。', icon: FaTrophy, items: ['GSoC 项目', 'AI 黑客松', '教育项目'], color: 'from-orange-500 to-red-500' },
  { title: '工具开发', description: '创建基本的开发者工具和库，让每个人都能更容易地使用 AI。', icon: FaCode, items: ['SDK 开发', '测试框架', 'DevOps 工具'], color: 'from-indigo-500 to-purple-500' },
  { title: '模型基准测试', description: '全面评估和比较 AI 模型，为社区提供指导。', icon: FaChartLine, items: ['性能测试', '成本分析', '质量指标'], color: 'from-teal-500 to-blue-500' },
];
